...
# used mean absolute instead of mean squared error, added two additional layers, back to softplus
BATCH_SIZE = 1000
EPOCHS = 20
INPUT_SIZE = 23
OUTPUT_SIZE = 1
model = tf.keras.models.Sequential()
model.add(tf.keras.layers.Dense(32, activation='softplus', input_shape=(INPUT_SIZE,), kernel_regularizer=tf.keras.regularizers.l2(0.001)))
...
model.compile(optimizer = optimize, loss='mean_absolute_error')
