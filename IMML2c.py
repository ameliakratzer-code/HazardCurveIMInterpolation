...
# 3 hidden layers but different sizes, increased learning rate
BATCH_SIZE = 800
EPOCHS = 20
INPUT_SIZE = 23
OUTPUT_SIZE = 1
model = tf.keras.models.Sequential()
model.add(tf.keras.layers.Dense(64, activation='softplus', input_shape=(INPUT_SIZE,), kernel_regularizer=tf.keras.regularizers.l2(0.001)))
